@title 代码生成器特别版 [springside4.2.3]  by -- wangchaoqun
@color a
@echo 1. 支持 H2.Mysql.Oracle.Sqlserver.PostgreSql.Sysbase.DB2.HsqlDB.Derby
@echo 2. 主要配置文件为generator.xml,可以修改数据库连接属性
